...
module.exports = {
    ...
    module: {
        ...
        rules: [
            //如下exports-loader规则与imports-loader同时使用出现问题，
            // 所以直接在main.js模块中直接使用require("exports-loader....")
            //而imports-loader在webpack配置中定义
           /* {
                //exports-loader导出案例
                //找到需要导出对象的库，该文件模拟以前开发模式的库（老旧的库）
                //写法二：var { file, parse } = require("exports-loader?file,parse=helpers.parse!./globals.js");
